...
class RFC_CLASS_ATTRIBUTE_DESC_STRUCT_API
...
feature {ANY} -- Member Access
	...
	declaringclass: POINTER
			-- Access member `declaringClass`
		require
			exists: exists
		do
			Result := c_declaringclass (item)
		ensure
			result_correct: Result = c_declaringclass (item)
		end
	...
	description: POINTER
		...
		do
			...
			result_correct: Result = c_description (item)
		end

	isreadonly: NATURAL
			-- Access member `isReadOnly`
		require
			exists: exists
		do
			Result := c_isreadonly (item)
		ensure
			result_correct: Result = c_isreadonly (item)
		end

	set_isreadonly (a_value: NATURAL) 
			-- Change the value of member `isReadOnly` to `a_value`.
		require
			exists: exists
		do
			set_c_isreadonly (item, a_value)
		ensure
			isreadonly_set: a_value = isreadonly
		end

	attributetype: INTEGER
			-- Access member `attributeType`
		require
			exists: exists
		do
			Result := c_attributetype (item)
		ensure
			result_correct: Result = c_attributetype (item)
		end

	set_attributetype (a_value: INTEGER) 
			-- Change the value of member `attributeType` to `a_value`.
		require
			exists: exists
		do
			set_c_attributetype (item, a_value)
		ensure
			attributetype_set: a_value = attributetype
		end
...
feature {NONE} -- Implementation wrapper for struct struct _RFC_CLASS_ATTRIBUTE_DESC

	sizeof_external: INTEGER 
		external
			"C inline use <sapnwrfc.h>"
		alias
			"sizeof(struct _RFC_CLASS_ATTRIBUTE_DESC)"
		end
	...
	c_name (an_item: POINTER): POINTER
		...
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->name
			]"
		end
	...
	c_type (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->type
			]"
		end
	...
	set_c_type (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->type =  (RFCTYPE)$a_value
			]"
		ensure
	...
	c_nuclength (an_item: POINTER): NATURAL
		...
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->nucLength
			]"
		end
	...
	set_c_nuclength (an_item: POINTER; a_value: NATURAL) 
		...
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->nucLength =  (unsigned)$a_value
			]"
		ensure
	...
	c_uclength (an_item: POINTER): NATURAL
		...
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->ucLength
			]"
		end
	...
	set_c_uclength (an_item: POINTER; a_value: NATURAL) 
		...
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->ucLength =  (unsigned)$a_value
			]"
		ensure
	...
	c_decimals (an_item: POINTER): NATURAL
		...
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->decimals
			]"
		end
	...
	set_c_decimals (an_item: POINTER; a_value: NATURAL) 
		...
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->decimals =  (unsigned)$a_value
			]"
		ensure
	...
	c_typedeschandle (an_item: POINTER): POINTER
		...
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->typeDescHandle
			]"
		end
	...
	set_c_typedeschandle (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->typeDescHandle =  (RFC_TYPE_DESC_HANDLE)$a_value
			]"
		ensure
	...
	c_defaultvalue (an_item: POINTER): POINTER
		...
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->defaultValue
			]"
		end

	c_declaringclass (an_item: POINTER): POINTER
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <sapnwrfc.h>"
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->declaringClass
			]"
		end
	...
	c_description (an_item: POINTER): POINTER
		...
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->description
			]"
		end

	c_isreadonly (an_item: POINTER): NATURAL
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <sapnwrfc.h>"
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->isReadOnly
			]"
		end

	set_c_isreadonly (an_item: POINTER; a_value: NATURAL) 
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <sapnwrfc.h>"
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->isReadOnly =  (unsigned)$a_value
			]"
		ensure
			isreadonly_set: a_value = c_isreadonly (an_item)
		end

	c_attributetype (an_item: POINTER): INTEGER
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <sapnwrfc.h>"
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->attributeType
			]"
		end

	set_c_attributetype (an_item: POINTER; a_value: INTEGER) 
		require
			an_item_not_null: an_item /= default_pointer
		external
			"C inline use <sapnwrfc.h>"
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->attributeType =  (RFC_CLASS_ATTRIBUTE_TYPE)$a_value
			]"
		ensure
			attributetype_set: a_value = c_attributetype (an_item)
		end
	...
	c_extendeddescription (an_item: POINTER): POINTER
		...
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->extendedDescription
			]"
		end
	...
	set_c_extendeddescription (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((struct _RFC_CLASS_ATTRIBUTE_DESC*)$an_item)->extendedDescription =  (void*)$a_value
			]"
		ensure
